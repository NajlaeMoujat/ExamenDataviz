...
Dans mon étude je ne me suis pas intéressée aux bénéfices financiers mais plutôt à l’aspect culturel du cinéma. Certes, d'une part il y a dans des colonnes des jeux de données que j’ai choisi d’occulter, mais d'autre part il y a des aspects que j’aurais aimé mettre en évidence mais qui n’était pas forcément présent, comme ( l’année 2021 et 2022 dû à la situation sanitaire mondiale )malgré que j’ai fait des recherches de dataset français, anglais, hispanique. Je n’ai rien trouvé de si permtinents dans mon étude et que j’ai décidé d’alimenter moi-même mon jeu de données comme le genre qui était pour moi, qui est intéressant à approfondir, de savoir quels sont les genres les plus appréciés des français, j’ai pris l’initiative d’ajouter 200 entrées au jeu de données «  les meilleurs succès depuis 1945 » manuellement. Après ça, j’ai dû faire un travail de raffinage et nettoyage sur OpenRefine pour que tous ces genres que j’ai ajouté comédie soient uniformes de sorte à être exploité par la suite dans le cadre d’une datavisualisation qui met en avant les genres.

 Avec OpenRefine, je me suis assuré de n’avoir aucun doublon pcq mon jeu de données était assez conséquent et que ce logiciel m’a permis de m’assurer de ne pas avoir de redondance rapidement.
...
J’ai pris prit plaisir à faire cette étude car je suis une véritable cinéphile, j’en ai appris davantage sur le sujet, en découvrant l’importance du cinéma, l’importance qu’elle a au sein de la France. C’est une expérience nouvelle car je n’ai jamais manipuler une base de données aussi importantes auparavant. L’air de  rien des outils tels que OpenRefine sont d’une grande aide. J’ai apprécié le travail qu’il est possible de faire via la datavisualisation en terme de représentation . La donnée a un véritable poids et qu’avec  un graphisme évocateur on peut en faire ressortir du potentiel
Finalement je me suis retrouver des jeux de données par moi-même, j’ai rencontré des limites les ressources en jeu de données ne sont pas inépuisable car elles sont assez minces dans le domaine du cinéma. Il y a quelques jeux de données notamment CNC (qu’on retrouve assez aisément 
J’ai été confronté à certaines limites à la fois techniques mais à la fois en termes de ressources car les jeux de données propre au cinéma français demeurent peu nombreux à part ceux mis à disposition par le centre national de cinéma et de l’image animé et quelques jeux de données mis à disposition tel que data.gouv.fr
...
Malgré avoir utilisé OpenRefine et avoir uniformisé les jeux de données parfois il y a des données qui apparaissaient en doublon ou en catégorie distincte alors qu’il s’agissait de la même nomenclature en faisant attention à la casse, du coup ça biaisait ma datavisualisation ce qui m’a conduit à ne pas représenter ces valeurs-ci.
